...
@Controller
@RequestMapping("/AceAdmin")
public class AceAdminTemplateController extends AbstractViewController{

	
	public AceAdminTemplateController() {
    ...
    public String getAll(Model model,HttpServletRequest request,HttpServletResponse response){
        ...
        return "ace-admin-template-example";
    }
