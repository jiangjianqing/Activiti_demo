...
public class GenericHibernateDaoImpl<T extends Serializable, PK extends Serializable> 
        extends HibernateDaoSupport implements GenericHibernateDao<T, PK> { 
    // 实体类类型(由构造方法自动赋值) 
    ...
    // 增加或更新集合中的全部实体 
    //该方法在新hibernate中已经被屏蔽 2015.03.21
    /*
  ...
  //获取当前Connection
    public Connection getConnection() throws SQLException{
    	return org.springframework.orm.hibernate4.SessionFactoryUtils.getDataSource(getSessionFactory()).getConnection();
    }
    
    //获取当前DataSource
    public DataSource getDataSource(){
    	return org.springframework.orm.hibernate4.SessionFactoryUtils.getDataSource(getSessionFactory());
    }
} 