...
public class ActivitiUtil {
	...
	public static ModelAndView getExecutionList() {
		...
		List<Execution> executionList = getExecutionListByUserId(user.getUserName());
		//查询流程定义对象
	...
	public static List<Execution> getExecutionListByUserId(String userId){
		RuntimeService runtimeService = SpringContextHolder.getBean(RuntimeService.class);
		//2017.09.10，在语句中加入了distinct，过滤重复数据，但没有考虑性能
		String sql = "select distinct RES.* from ACT_RU_EXECUTION RES left join " + 
